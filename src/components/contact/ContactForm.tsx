...
export default function ContactForm() {
  ...
  return (
    <div className='bg-fresh-black px-7 py-7 rounded-[5px] md:px-14 md:w-[75%] md:mx-auto lg:w-auto lg:mx-0 lg:col-span-6 lg:col-start-7 xl:col-span-4 xl:col-start-8 xl:flex xl:items-center'>
