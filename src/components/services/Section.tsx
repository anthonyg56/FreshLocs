  ...
  return (
    <div className='slide'>
      <div className='sect overflow-hidden'>
        <div className='md:grid md:grid-rows-[10%_90%] lg:grid-rows-[25%_75%] h-full'>
          <Heading title="OUR SERVICES" subTitle="Until recently, the prevailing view assumed lorem ipsum was born as a nonsense text." />

          <div className={`md:grid md:grid-cols-[1fr_1fr] lg:grid-cols-[1fr_1fr_1fr_1fr] md:gap-[20px] pt-7 md:pt-0`}>
